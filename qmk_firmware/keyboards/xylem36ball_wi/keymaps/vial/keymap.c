...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_L0] = LAYOUT(
        ...
        // 4段目(5)
        LT(1, KC_NO), LALT_T(KC_INT5), LCTL_T(KC_GRV), LT(3, KC_SPC), LT(2, KC_BSPC), KC_A
    ),
    ...
    [_L1] = LAYOUT(
        ...
        // 4段目(5)
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_A
    ),
    ...
    [_L3] = LAYOUT(
        ...
        // 4段目(5)
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL, KC_A
    ),
};
